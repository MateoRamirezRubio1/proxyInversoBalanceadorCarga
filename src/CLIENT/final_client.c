...
// #define SERVER_IP "44.203.64.241"
#define SERVER_IP "52.87.161.68"
...
int menu() {
    ...
    printf("3. If you want to make a GET method to obtain a resource other than txt or html.\n");
    printf("4. If you want to flush the cache.\n");
    printf("5. EXIT.\n");
