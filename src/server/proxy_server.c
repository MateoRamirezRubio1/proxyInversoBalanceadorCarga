...
#define MAX 2048 // Define el tamaño máximo de los buffers utilizados.
#define SERVER_COUNT 3 // Especifica el número de servidores web Apache configurados.
#define SERVER_IP "44.207.6.109" // Dirección IP del servidor proxy para uso en encabezados HTTP.
